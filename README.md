...
AgentRunner uses a structured 3-step workflow for task execution, ensuring comprehensive documentation is generated before implementation begins.
...
```
.agentrunner/tasks/t-1_implement-user-auth/
...
AgentRunner includes two built-in skills that are automatically copied to your workspace during initialization (same timing as bootstrap detection):
...
Skills are stored at `.agentrunner/skills/` in your workspace. They are copied once on first access and can be customized for your project's needs.
